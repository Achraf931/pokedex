<template>
  <section class="flex-1 flex flex-col items-center justify-center w-full max-w-screen p-10 md:p-5">
    <div class="flex items-center justify-center gap-5 text-[180px] font-extrabold">
      <h1>4</h1>
      <div class="pokeball">
        <div class="pixel"></div>
      </div>
    ...
    <router-link to="/" class="button mt-10">Go Home!</router-link>
  </section>
</template>
...
.pixel {
  ...
  box-shadow:
    ...
    4rem 0rem 0 -0.05rem #000,
    5rem 0rem 0 -0.05rem #000,
    6rem 0rem 0 -0.05rem #000,
    7rem 0rem 0 -0.05rem #000,
    ...
    10rem 2rem 0 -0.05rem #000,
    11rem 2rem 0 -0.05rem #fff,
      /* row 4 */
    0rem 3rem 0 -0.05rem #fff,
    1rem 3rem 0 -0.05rem #000,
    ...
    10rem 3rem 0 -0.05rem #000,
    11rem 3rem 0 -0.05rem #fff,
      /* row 5 */
    0rem 4rem 0 -0.05rem #000,
    ...
    4rem 11rem 0 -0.05rem #000,
    5rem 11rem 0 -0.05rem #000,
    6rem 11rem 0 -0.05rem #000,
    7rem 11rem 0 -0.05rem #000,
